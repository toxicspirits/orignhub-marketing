...
export function WaitlistForm() {
  ...
  if (isSuccess) {
    return (
      <div className="p-8 md:p-12 text-center bg-[#111] border border-border/10 rounded-2xl shadow-2xl">
        <div className="w-16 h-16 bg-primary/20 text-primary rounded-full flex items-center justify-center mx-auto mb-6">
          <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
          </svg>
        </div>
        <h3 className="text-3xl font-bold text-white mb-3 tracking-tight">You're in. We'll be in touch.</h3>
        <p className="text-lg text-zinc-400">We'll reach out when early access opens. Keep building.</p>
      </div>
    );
  }
